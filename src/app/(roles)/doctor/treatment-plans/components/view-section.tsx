...
const ViewSection = () => (
	<Card className="flex-1 px-4">
		<CardHeader className="pb-3 px-0">
			...
			<div className="w-fit py-1 px-2 flex items-center gap-x-2 bg-hubGrey/20 rounded-full">
				<div className="size-6 flex items-center justify-center rounded-full border-2 border-hubGrey200">
					<User className="size-[80%]" />
				</div>
				<p className="text-hubBlue text-xs">Samuel Anderson</p>
			</div>
		</CardHeader>
		<CardContent className="px-0">
			<p className="mb-1">Prescriptions</p>
			<div className="p-3 space-y-3 bg-hubGrey rounded-xl">
				{meds.map((med, i) => (
					<div
						key={i}
					...
					>
						...
						<div className="flex flex-col items-center justify-between">
							<div className="size-7 flex items-center justify-center rounded-full bg-hubRed/30 text-hubRed/90">
								<Droplet className="size-[80%]" />
							</div>
							<Button className="p-0 bg-transparent text-hubBlack hover:bg-transparent">
		...
		<CardFooter className="px-0 flex flex-col items-start">
			...
			<div className="bg-hubGrey rounded-lg p-2.5">
