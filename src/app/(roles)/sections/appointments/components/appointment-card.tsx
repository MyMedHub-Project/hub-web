		...
		<CardContent className="p-4  space-y-2">
			<div className="flex items-center space-x-4">
				...
				<div className="flex-1 flex items-center justify-between mb-1">
					...
					<Button
						variant="ghost"
						className="size-9 bg-hub-grey rounded-full flex items-center justify-center justify-self-end"
					>
						<div className="bg-hub-blue p-0.5 rounded-full flex items-center justify-center">
			...
			<div className="flex justify-between gap-x-2 mt-3">
				<Button
					variant="outline"
					className="flex-1 grow bg-hub-green-light text-hub-green hover:bg-hub-green/30"
				>
				...
				<Button
					variant="outline"
					className="w-10 px-2 grow bg-hub-grey hover:bg-hub-grey200"
				>
					<X className="size-5" />
					Cancel
				</Button>
