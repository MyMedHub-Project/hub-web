...
import { BellSVGComponent, ChatIconSVGComponent, SearchIconSVGComponent } from "../icons";
import { Separator } from "../ui/separator";

const DashboardNavbar = () => {
	return (
		<div className="grid grid-cols-3 gap-5 items-center justify-between p-5 text-hubBlack min-w-7xl w-full">
			{/* USER NAME */}
			<div className="flex flex-col leading-relaxed">
				<h2 className="text-xl font-bold leading-tight">Hello Anderson.</h2>
			...
			<div className="flex items-center gap-6 justify-end w-full ">
				<div className="bg-white rounded-full w-7 h-7 flex items-center justify-center cursor-pointer relative">
					<MessageCircleIcon />
					<div className="absolute -top-1 -right-1 w-4 h-4 flex items-center justify-center bg-hubRed text-white rounded-full text-xs">1</div>
				</div>
				<div className="bg-white rounded-full w-7 h-7 flex items-center justify-center cursor-pointer relative">
					<BellSVGComponent />
					<div className="absolute -top-1 -right-1 w-4 h-4 flex items-center justify-center bg-hubRed text-white rounded-full text-xs">1</div>
