...
const Appointments = () => {
	const [appointments] = useState<AppointmentData[]>(
		Array(4).fill(appointmentsData)
	);

	return (
		<div className="p-4 rounded-lg space-y-3 bg-hubGrey text-hubBlack divide-y">
			<h1 className="text-lg font-semibold">Upcoming Appointments</h1>

			<div className="pt-4 space-y-3 max-h-[calc(100%-40px)] overflow-y-hidden custom-scrollbar">
